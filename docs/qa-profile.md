...
## Local development
- `make up`
- Uses [docker-compose.yml](/home/devadmin/projects/urban-octo-bassoon/docker-compose.yml)
...
- `make up-prod-local`
- Uses [docker-compose.prod-local.yml](/home/devadmin/projects/urban-octo-bassoon/docker-compose.prod-local.yml)
