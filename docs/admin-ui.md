...
- **Catalog + settings**: Browse the live catalog, search/filter routes, export/import the full route bundle, review live telemetry summaries for recent runtime traffic, and edit endpoint identity/runtime behavior without competing against the schema canvas.
